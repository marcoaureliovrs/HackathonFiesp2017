...
public final class LocationUtils {
    ...
    public static String getLatLng(Context context, Location currentLocation) {
        ...
        if (currentLocation != null) {
        	String lat = StringUtilsService.formatLatLng(String.valueOf(currentLocation.getLatitude()));
        	String lng = StringUtilsService.formatLatLng(String.valueOf(currentLocation.getLongitude()));
